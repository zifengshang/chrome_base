...
// yinzhou: parts of binary value serialize/deserialize support
#define BINARY_BASE64_ENCODE_HEADER "~*#$binary_base64_encode_header^&@`"
#define BINARY_BASE64_ENCODE_TAIL   "^&@`binary_base64_encode_tail~*#$"
#endif
